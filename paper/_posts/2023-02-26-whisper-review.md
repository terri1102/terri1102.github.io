...
published: true
future: true
date: 2023-02-26T08:30:50-04:00
tags:
    - STT
    - OpenAI
---
...
> 💡
강건한 음성인식 모델로 OpenAI에서 발표 <br>
엄청 많은 튜닝과 휴리스틱 사용 → noisy한 데이터여서 이를 보완하기 위한 트릭 사용
<br>
<br>
...
Wav2Vec 2.0 의 등장 이후 Unsupervised pretraining 방식을 많이 사용
...
→ 음성 인식은 어떤 상황에서도 reliable 해야 함 & 매 상황에 따라 디코더를 fine-tuning할 필요가 없어야 함
...
close the gap between supervised and unsupervised (unsupervised의 100만 시간 vs. 기존 supervised의 5140H)
...
- Inverse text normalization(ITN)
    ...
    numbers, dates, times, addresses 등 formatting하는 작업
...
인터넷에서 찾은 오디오-대본 쌍 사용

- 퀄리티가 일정하지 않기 때문에 automated filtering 사용
...
- Multi-lingual Speech Recognition
    - Indo-European vs. others
        
        데이터셋의 대부분이 Indo-European 데이터이기 때문에 Indo-European 언어의 성능이 더 높음
...
Dataset [https://huggingface.co/datasets/google/fleurs](https://huggingface.co/datasets/google/fleurs)
